...
from model_v1 import swin_base_patch4_window12_384_in22k as create_model
...
def main():
    ...
    # load model weights
    model_weight_path = "weights/model-5.pth"
    ...
    with torch.no_grad():
        ...
        # print('output: ',output)
        # outputa_un = model(img.to(device)).cpu()
        # print('output: ',outputa_un)
